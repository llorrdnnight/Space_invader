#Space Invaders - by tutorial part 1
#set up the screen
#Python 2.7 on mac > python 3.6.3 on windows
...
number_of_enemies = 5
#Create list of number_of_enemies
enemies = []
...
while True:
    for enemy in enemies:
        ...
        if isCollision(bullet, enemy):
            ...
            score_pen.clear()
            score_pen.write(scorestring, False, align="left", font=("Arial", 14, "normal"))
            #score_pen.hideturtle() - don't think this one is needed tbh
